...
RSpec.describe "As a user,", type: :feature do
  describe "When I go to a mechanics show page" do
    ...
    it "If I enter an invalid id into the ride id form,
    then I see a flash message telling me that the ride doesn't exist" do
      mechanic = Mechanic.create(           name: "Kara Smith",
                                            years_experience: 11)
      ...
      fill_in "Ride", with: "yeet"
      click_button "Submit"

      expect(page).to have_current_path("/mechanics/#{mechanic.id}")
      expect(page).to have_content("Could not find ride of given ID")
    end
  end
end
# Story 3
